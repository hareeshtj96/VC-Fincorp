...
const Features = () => {
  ...
  return (
    <div className="bg-gray-100 py-12 pt-[60px] sm:pt-[100px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            ...
            >
              ...
              <a
                href={feature.link}
                className={`inline-block text-black py-3 px-8 rounded-full text-lg font-semibold shadow-lg transition-all ${feature.gradient} hover:opacity-80`}
              >
                Learn More →
              </a>
            </div>
